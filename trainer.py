...
class Trainer:
    ...
    def train(self, train_data, test_data, model_manager):
        ...
        for epoch in xrange(self.n_epoch):
            ...
            # self.train_one_epoch(test_data, epoch)
    ...
    def train_one_epoch(self, train_data, epoch):
        ...
        for i, data_batch in enumerate(train_data):
            ...
            vids_long, len_long, vids_short_al, len_short_al, short_cnt, mask_long, vids_next, mask_optim, mask_evaluate = self.convert_to_variable(data_batch)
            outputs = self.model(vids_long, len_long, vids_short_al, len_short_al, short_cnt, mask_long, mask_optim, mask_evaluate)
            # print outputs, vids_next
            # raw_input()
